        ...
        <div className="absolute inset-0 flex items-center justify-start pr-22">
          <div className="transform -translate-x-24 rotate-58 origin-center whitespace-nowrap">
            <motion.h1 
              ...
              transition={{ 
                duration: 0.8,
                delay: 1.2 // Delay after polygon animation
              }}
              className="text-white text-[5rem] font-bold tracking-wider"
            >
              JOURNEY OF BBMAM
            </motion.h1>
          </div>
        ...
        <div className="absolute inset-0 flex items-start justify-center pt-20">
          <div className="relative">
            <motion.h1 
              ...
              className="text-white text-4xl font-bold tracking-wider text-center drop-shadow-lg"
            >
              JOURNEY OF BBMAM
            </motion.h1>
